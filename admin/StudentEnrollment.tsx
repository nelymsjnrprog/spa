        ...
        return (
            <div className="min-h-screen bg-slate-50 flex items-center justify-center">
                ...
                <div className="text-center p-12">
                    ...
                    <p className="text-black mt-2">Only Super Administrators can perform manual student enrollment.</p>
        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <Container>
                <div className="mb-8">
                    ...
                    <h1 className="text-3xl font-black text-black tracking-tight">Student Enrollment</h1>
                    <p className="text-black font-medium">Create and enroll students manually, bypassing public payment gates.</p>
                </div>
                ...
                <div className="max-w-3xl mx-auto">
                    ...
                    <Card className="p-8 border-none shadow-2xl shadow-slate-200/60 relative overflow-hidden">
                        ...
                        <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
                            ...
                            {success && (
                                <div className="bg-emerald-50 border-l-4 border-emerald-500 p-4 rounded-r-xl animate-in slide-in-from-top-2">
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-[10px] font-black text-black uppercase tracking-widest mb-2 ml-1">Full Name *</label>
                                            <input 
                                                type="text" 
                                                value={name} 
                                    ...
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-[10px] font-black text-black uppercase tracking-widest mb-2 ml-1">Phone Number</label>
                                            <input 
                                                type="tel" 
                                                value={phoneNumber} 
                                        ...
                                        <div>
                                            <label className="block text-[10px] font-black text-black uppercase tracking-widest mb-2 ml-1">Account Password *</label>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-[10px] font-black text-black uppercase tracking-widest mb-2 ml-1">Institution *</label>
                                    <select 
                                        value={institution} 
                                ...
                                <div>
                                    <label className="block text-[10px] font-black text-black uppercase tracking-widest mb-2 ml-1">Academic Level *</label>
                                    <select 
                                        value={level} 
                            ...
                            <div>
                                <label className="block text-[10px] font-black text-black uppercase tracking-widest mb-2 ml-1">Academic Program *</label>
                                <select 
                                    value={program} 
                            ...
                            <div className="bg-slate-50 p-6 rounded-2xl border border-slate-100">
                                <label className="block text-[10px] font-black text-black uppercase tracking-widest mb-4">Enrollment Status Override</label>
                                <div className="flex gap-4">
                                    <button
                                        ...
                                        className={`flex-1 py-4 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${membershipStatus === 'active' 
                                            ...
                                            : 'bg-white text-black border border-slate-200 hover:border-emerald-200 hover:text-emerald-600'
                                        }`}
                                    >
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 py-4 rounded-xl text-xs font-black uppercase tracking-widest transition-all ${membershipStatus === 'pending' 
                                            ...
                                            : 'bg-white text-black border border-slate-200 hover:border-amber-200 hover:text-amber-500'
                                        }`}
                                    >
