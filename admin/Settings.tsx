        ...
        <div className="min-h-screen bg-slate-50">
            ...
            <Container>
                <div className="mb-10">
                    ...
                    <p className="text-slate-600 font-medium">Configure core academic and administrative parameters.</p>
                </div>
                    ...
                    <div className="p-8">
                        <div className="flex gap-4 mb-8">
                            <input
                                ...
                                className="flex-1 px-4 py-3 rounded-xl bg-slate-50 border-none focus:ring-2 focus:ring-primary-500 focus:bg-white outline-none transition text-sm text-slate-900"
                        ...
                        {loading ? (
                            <div className="py-10 text-center text-slate-900 font-bold uppercase tracking-widest animate-pulse">Loading institutions...</div>
