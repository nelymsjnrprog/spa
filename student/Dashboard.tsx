        ...
        <div className="bento-grid">
          ...
          <section className="bento-item-large space-y-6">
            <div className="flex items-center justify-between">
              ...
              {quizzesLoaded && (
                <span className="text-[10px] font-black text-slate-500 bg-slate-100 px-3 py-1 rounded-full">{quizzes.length} AVAILABLE</span>
              )}
            </div>
            ...
            {!quizzesLoaded ? (
              ...
              <Card variant="glass" className="p-16 text-center border-dashed border-2 border-slate-200 bg-transparent flex flex-col items-center">
                ...
                <p className="text-slate-900 font-bold text-lg">Your queue is currently empty.</p>
                    ...
                    <Card key={quiz.id} className="p-3 flex items-center gap-4 hover:bg-slate-50/50 transition-all border-slate-100 shadow-none group">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <div className="flex items-center space-x-2">
                          <div className="flex items-center text-[9px] font-bold text-slate-600 bg-slate-50 rounded-md px-2 py-0.5 border border-slate-100">
