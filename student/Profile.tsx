      ...
      <Container>
        <div className="max-w-4xl mx-auto">
          <div className="mb-8">
            ...
            <p className="text-slate-600">Manage your identity and security preferences.</p>
          </div>
            ...
            <div className="md:col-span-2 space-y-6">
              <Card className="p-6">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <div className="p-3 bg-slate-50 rounded-lg text-slate-900 font-medium border border-slate-100">{profile?.displayName}</div>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Email Address</label>
                    <div className="p-3 bg-slate-50 rounded-lg text-slate-900 font-medium border border-slate-100">{profile?.email}</div>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Phone Number</label>
                    <div className="p-3 bg-slate-50 rounded-lg text-slate-900 font-medium border border-slate-100">{profile?.phoneNumber || 'N/A'}</div>
                  </div>
                  <div>
                    <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Account Created</label>
              ...
              <Card className="p-6">
                ...
                <div className="space-y-4">
                    ...
                    {isEditing ? (
                      <div className="relative">
                        <select
                          ...
                          className={`w-full px-4 py-3 rounded-xl border focus:ring-2 outline-none transition bg-white ${profile?.institution !== 'Pending' && !!profile?.institution ? 'bg-slate-50 border-slate-200 cursor-not-allowed text-slate-900 appearance-none' : 'border-primary-200 focus:ring-primary-500'}`}
                        >
                      ...
                      <div className="p-3 bg-slate-50 rounded-lg text-slate-900 font-bold border border-slate-100 flex items-center">
                  ...
                  <div>
                    <label className="block text-xs font-bold text-slate-500 uppercase mb-1">Academic Level</label>
                    {isEditing ? (
                      <div className="relative">
                        <select
                          ...
                          className={`w-full px-4 py-3 rounded-xl border focus:ring-2 outline-none transition bg-white ${profile?.level ? 'bg-slate-50 border-slate-200 cursor-not-allowed text-slate-900 appearance-none' : 'border-primary-200 focus:ring-primary-500'}`}
                        >
                    ...
                    {isEditing ? (
                      <div className="relative">
                        <select
                          ...
                          className={`w-full px-4 py-3 rounded-xl border focus:ring-2 outline-none transition bg-white ${profile?.program ? 'bg-slate-50 border-slate-200 cursor-not-allowed text-slate-900 appearance-none' : 'border-primary-200 focus:ring-primary-500'}`}
                        >
              ...
              <Card className="p-6 border-red-100 bg-red-50/20">
                ...
                <p className="text-sm text-slate-600 mb-6">Changing your password or email requires re-authentication for security purposes.</p>
                <button
