      ...
      <div className="min-h-screen w-full flex flex-col items-center py-12 px-6 sm:py-20">
        <div className="w-full max-w-5xl">
          ...
          <div className="mb-20 text-center md:text-left">
            ...
            <p className="text-slate-600 font-medium text-xl">Get in touch with the SmartPrepAca team.</p>
          </div>
          ...
          <div className="flex flex-col md:flex-row gap-16 lg:gap-24">
            ...
            <div className="flex-1 space-y-8">
              <div>
                ...
                <p className="text-slate-600">We'd love to hear from you. Fill out the form below and we'll be in touch.</p>
              </div>
              ...
              {submitted ? (
                <div className="bg-primary-50 border border-primary-100 p-8 rounded-3xl text-center animate-in zoom-in-95 duration-500">
                  ...
                  <p className="text-slate-600 font-medium">Thank you for reaching out. We'll get back to you shortly.</p>
                </div>
              ) : (
